...
public class PredictionTF_zone0618_medium_pocket{
    ...
    private static final String modePath="file:///android_asset/190618_medium_pocket.pb";
    ...
    PredictionTF_zone0618_medium_pocket(AssetManager assetManager) {
