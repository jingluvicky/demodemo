...
public class PredictionTF_distance0711 {
    ...
    //模型中输入变量的名称
    private static final String inputName = "lstm_3_input";
    //模型中输出变量的名称
    private static final String outputName = "output_0";
    private static final String modePath="file:///android_asset/LSTM_0712_distance.pb";
    ...
    PredictionTF_distance0711(AssetManager assetManager) {
